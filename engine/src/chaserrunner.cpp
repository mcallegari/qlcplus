...
quint32 ChaserRunner::stepFadeIn(int stepIdx) const
{
    ...
    case Chaser::Common:
        ...
        fadeIn = m_chaser->commonSpeeds().fadeIn();
        break;
    case Chaser::PerStep:
...
quint32 ChaserRunner::stepFadeOut(int stepIdx) const
{
    ...
    case Chaser::Common:
        ...
        fadeOut = m_chaser->commonSpeeds().fadeOut();
        break;
    case Chaser::PerStep:
...
uint ChaserRunner::stepHold(int stepIdx) const
{
    ...
    case Chaser::Common:
        ...
        hold = m_chaser->commonSpeeds().hold();
        break;
    case Chaser::PerStep:
...
uint ChaserRunner::stepDuration(int stepIdx) const
{
    ...
    case Chaser::Common:
        ...
        duration = m_chaser->commonSpeeds().duration();
        break;
    case Chaser::PerStep:
    ...
    foreach(ChaserRunnerStep *step, m_runnerSteps)
    {
        ...
        else
        {
            ...
            if (m_updateOverrideSpeeds)
            {
                ...
                {
                    step->m_function->overrideSpeedsEdit().setFadeIn(step->m_speeds.fadeIn());
                    step->m_function->overrideSpeedsEdit().setFadeOut(step->m_speeds.fadeOut());
                }
            }
        }
    }
