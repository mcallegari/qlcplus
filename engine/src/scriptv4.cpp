...
const QString Script::waitFunctionLegacy = QString("waitfunction");
const QString Script::waitFunctionCmd = QString("Engine.waitFunction");
...
QString Script::convertLegacyMethod(QString method)
{
    ...
    else if (method == waitFunctionLegacy) return waitFunctionCmd;
