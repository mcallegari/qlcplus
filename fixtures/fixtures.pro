...
# The part below is autogenerated by script. Do not edit!
# BEGIN FIXTURES
...
fixtures.files += American-DJ-Fusion-FX-Bar-5.qxf
...
fixtures.files += American-DJ-P64-LED-Plus.qxf
...
fixtures.files += American-DJ-SP1500-MKII.qxf
fixtures.files += American-DJ-Spherion-Tri-LED.qxf
fixtures.files += American-DJ-Sweeper-Beam-LED.qxf
...
fixtures.files += BoomToneDJ_Slim_PAR_7x3W_LED_RGB.qxf
fixtures.files += Botex-DSP-405.qxf
fixtures.files += Briteq-BT-W07L12.qxf
fixtures.files += Briteq-BT-W12L10.qxf
fixtures.files += Cameo-Flat-PAR-CAN-TRI-3W.qxf
...
fixtures.files += Chauvet-Circus-2.qxf
...
fixtures.files += Chauvet-Gobo-Zoom-LED-2.0.qxf
...
fixtures.files += Chauvet-Intimidator-Beam-LED-350.qxf
fixtures.files += Chauvet-Intimidator-Scan-LED-200.qxf
fixtures.files += Chauvet-Intimidator-Scan-LED-300.qxf
fixtures.files += Chauvet-Intimidator-Spot-250.qxf
fixtures.files += Chauvet-Intimidator-Spot-LED-250.qxf
fixtures.files += Chauvet-Intimidator-Spot-LED-350.qxf
fixtures.files += Chauvet-LED-Splash-86b.qxf
fixtures.files += Chauvet-LED-Techno-Strobe-RGB.qxf
...
fixtures.files += Chauvet-Wedge-Tri.qxf
fixtures.files += Chavet-Legend-230SR-Beam.qxf
...
fixtures.files += Eurolite-LED-PAR-56-RGB-DMX.qxf
...
fixtures.files += Eurolite-PST-9W-RGB.qxf
...
fixtures.files += Flash-Butrym-LED-Moving-Head-Mini-Beam-18x3W-RGB-CREE.qxf
...
fixtures.files += lightmaXX-Star-Sphere-6-RGBAW.qxf
...
fixtures.files += Martin-MAC-700-Profile.qxf
...
fixtures.files += Pro-Lights-LumiPAR12Q.qxf
...
fixtures.files += Proel-Analogue-Dimmer-6Ch.qxf
...
fixtures.files += Robe-ColorSpot-700E-AT.qxf
...
fixtures.files += Showtec-Event-Spot-1800-Q4.qxf
fixtures.files += Showtec-Indigo-4600.qxf
...
fixtures.files += Showtec-Phantom-250-Wash.qxf
fixtures.files += Showtec-Phantom-250.qxf
fixtures.files += Showtec-Phantom-50.qxf
fixtures.files += Showtec-Quatro.qxf
...
fixtures.files += Stairville-DDS-405.qxf
fixtures.files += Stairville-LED-bar-240-8-RGB.qxf
...
fixtures.files += Stairville-maTrixx-SC-100.qxf
...
fixtures.files += Stairville-Quad-Par-Profile-RGBW-5x8W.qxf
...
fixtures.files += Varytec-LED-Magic-Mushroom.qxf
