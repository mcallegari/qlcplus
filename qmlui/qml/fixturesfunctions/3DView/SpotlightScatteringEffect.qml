                ...
                RenderPass
                {
                    ...
                    shaderProgram:
                        ShaderProgram
                        {
                            ...
                            fragmentShaderCode: View3D.makeGlShader(loadSource("qrc:/spotlight_scattering.frag"))
                        }
                }
            ]
        },
                ...
                RenderPass
                {
                    ...
                    shaderProgram:
                        ShaderProgram
                        {
                            ...
                            fragmentShaderCode: View3D.makeRhiShader(loadSource("qrc:/spotlight_scattering_rhi.frag"))
                        }
                }
            ]
        }
