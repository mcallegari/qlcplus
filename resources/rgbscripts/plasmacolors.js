...
algo.color3Index = 16;
algo.properties.push("name:color3Index|type:list|display:Color 3|" +
                     "values:" + colorPalette.names.toString() + "|" +
                     "write:setColor3|read:getColor3");
algo.color4Index = 22;
algo.properties.push("name:color4Index|type:list|display:Color 4|" +
                     "values:" + colorPalette.names.toString() + "|" +
                     "write:setColor4|read:getColor4");
algo.color5Index = 31;
algo.properties.push("name:color5Index|type:list|display:Color 5|" +
                     "values:" + colorPalette.names.toString() + "|" +
                     "write:setColor5|read:getColor5");
algo.presetSize = 5;
algo.properties.push("name:presetSize|type:range|display:Size|" +
                     "values:1,20|write:setSize|read:getSize");
algo.ramp = 15;
algo.properties.push("name:ramp|type:range|display:Ramp|" +
                     "values:10,30|write:setRamp|read:getRamp");
algo.stepsize = 25;
algo.properties.push("name:stepsize|type:range|display:Speed|" +
                     "values:1,50|write:setStep|read:getStep");
algo.colorIndex = new Array(algo.color1Index, algo.color2Index, algo.color3Index, algo.color4Index, algo.color5Index);
