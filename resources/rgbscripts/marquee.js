...
algo.edgeDepth = 2;
algo.properties.push("name:depth|type:range|display:Depth|values:1,10000|write:setDepth|read:getDepth");
algo.marquee = 0;
...
algo.properties.push("name:marqueColor|type:list|display:Marquee Light Color|" +
...
algo.rgbMap = function(width, height, rgb, step) {
  if (util.initialized === false || util.featureColor != rgb || util.width !== width || util.height !== height) {
