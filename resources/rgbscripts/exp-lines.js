...
(
  function()
  {
    ...
    algo.properties.push("name:linesDirection|type:list|display:Direction|values:Horizontal,Vertical,Both,Left,Right,Up,Down|write:setDirection|read:getDirection");
    algo.fadeMode = 0;
    ...
    algo.setDirection = function(_direction)
    {
      ...
      else if (_direction === "Both") { algo.linesDirection = 2; }
      else if (_direction === "Left") { algo.linesDirection = 3; }
      else if (_direction === "Right") { algo.linesDirection = 4; }
      else if (_direction === "Up") { algo.linesDirection = 5; }
      else if (_direction === "Down") { algo.linesDirection = 6; }
    ...
    algo.getDirection = function()
    {
      ...
      else if (algo.linesDirection === 2) { return "Both"; }
      else if (algo.linesDirection === 3) { return "Left"; }
      else if (algo.linesDirection === 4) { return "Right"; }
      else if (algo.linesDirection === 5) { return "Up"; }
      else if (algo.linesDirection === 6) { return "Down"; }
      ...
      for (var i = 0; i < algo.linesAmount; i++)
      {
        ...
        else
        {
          ...
          for (x = 0; x <= l; x++)
          {
            ...
            if (algo.linesDirection == 0 || algo.linesDirection == 2 || algo.linesDirection == 3) {
              util.drawPixel(lines[i].xCenter - x, lines[i].yCenter, color, width, height);
            } 
            if (algo.linesDirection == 0 || algo.linesDirection == 2 || algo.linesDirection == 4) {
              util.drawPixel(lines[i].xCenter + x, lines[i].yCenter, color, width, height);
            }
            if (algo.linesDirection == 1 || algo.linesDirection == 2 || algo.linesDirection == 5) {
              util.drawPixel(lines[i].xCenter, lines[i].yCenter - x, color, width, height);
            }
            if (algo.linesDirection == 1 || algo.linesDirection == 2 || algo.linesDirection == 6) {
              util.drawPixel(lines[i].xCenter, lines[i].yCenter + x, color, width, height);
            }
          }
        }
