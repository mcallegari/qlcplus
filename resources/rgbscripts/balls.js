...
(
  function () {
    ...
    algo.presetNumber = 5;
    algo.properties.push('name:presetNumber|type:range|display:Number|values:1,10|write:setNumber|read:getNumber');
    ...
    algo.presetColors = 1;
    algo.properties.push('name:presetColors|type:list|display:Color Type|values:QLC+,Fixed,Random|write:setColors|read:getColors');
    ...
    algo.color6Index = 27;
    algo.properties.push(
      'name:color6Index|type:list|display:Color 6|' +
      'values:' + colorPalette.names.toString() + '|' +
      'write:setColor6|read:getColor6');
    algo.color7Index = 26;
    algo.properties.push(
      'name:color7Index|type:list|display:Color 7|' +
      'values:' + colorPalette.names.toString() + '|' +
      'write:setColor7|read:getColor7');
    algo.color8Index = 17;
    algo.properties.push(
      'name:color8Index|type:list|display:Color 8|' +
      'values:' + colorPalette.names.toString() + '|' +
      'write:setColor8|read:getColor8');
    algo.color9Index = 10;
    algo.properties.push(
      'name:color9Index|type:list|display:Color 9|' +
      'values:' + colorPalette.names.toString() + '|' +
      'write:setColor9|read:getColor9');
    algo.color10Index = 19;
    algo.properties.push(
      'name:color10Index|type:list|display:Color 10|' +
      'values:' + colorPalette.names.toString() + '|' +
      'write:setColor10|read:getColor10');
    ...
    algo.setColors = function (_colors) {
      if (_colors === 'QLC+') algo.presetColors = 0;
      else if (_colors === 'Fixed') algo.presetColors = 1;
      else if (_colors === 'Random') algo.presetColors = 2;
      algo.initialized = false;
    };
    algo.getColors = function () {
      if (algo.presetColors === 0) return 'QLC+';
      else if (algo.presetColors === 1) return 'Fixed';
      else if (algo.presetColors === 2) return 'Random';
    };

    algo.setCollision = function (_collision) {
      if (_collision === 'Yes') algo.presetCollision = 0;
      else if (_collision === 'No') algo.presetCollision = 1;
    };
    ...
    algo.setColor6 = function (_preset) {
      algo.color6Index = algo.setColor(5, _preset);
      algo.initialized = false;
    };
    algo.getColor6 = function () {
      return algo.getColor(5);
    };
    algo.setColor7 = function (_preset) {
      algo.color7Index = algo.setColor(6, _preset);
      algo.initialized = false;
    };
    algo.getColor7 = function () {
      return algo.getColor(6);
    };
    algo.setColor8 = function (_preset) {
      algo.color8Index = algo.setColor(7, _preset);
      algo.initialized = false;
    };
    algo.getColor8 = function () {
      return algo.getColor(7);
    };
    algo.setColor9 = function (_preset) {
      algo.color9Index = algo.setColor(8, _preset);
      algo.initialized = false;
    };
    algo.getColor9 = function () {
      return algo.getColor(8);
    };
    algo.setColor10 = function (_preset) {
      algo.color10Index = algo.setColor(9, _preset);
      algo.initialized = false;
    };
    algo.getColor10 = function () {
      return algo.getColor(9);
    };
    ...
    algo.rgbMap = function (width, height, rgb, progstep) {
      ...
      for (var i = 0; i < algo.presetNumber; i++) {  // for each ball displayed
        if (algo.presetColors >= 1) rgb = algo.colour[i];  // use RGB ball preset color
        ...
        if (algo.presetCollision === 0) {  // if collision detection is on
