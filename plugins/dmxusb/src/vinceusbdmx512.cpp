...
VinceUSBDMX512::VinceUSBDMX512(DMXInterface *_interface, quint32 outputLine)
...
bool VinceUSBDMX512::open(quint32 line, bool input)
{
    ...
    if (_interface()->write(QByteArray(2, 0x00)) == false)
        return false;
...
bool VinceUSBDMX512::writeData(Command command, const QByteArray &data)
{
    ...
    return _interface()->write(message);
}
