...
void IdnPacketizer::setupIdnDmx(QByteArray& data, const quint8 &mode, const quint8 &channelID,
                                const QByteArray &values, const quint16 offset, const quint32 seqnum, const bool config,
...
void IdnPacketizer::setupIdnDmx(QByteArray& data, const quint8 &mode, const quint8 &channelID,
                                const QByteArray &values, const QList<QPair<int, int> > ranges, const quint32 seqnum,
                                const bool config, const quint8 serviceID)
{
    data.clear();
    IDNDMX_PACKET packet;
    InitDMXPacket(&packet);
...
void IdnPacketizer::generateNullPacket(QByteArray& data, const quint32 seqnum, const quint8 &mode,
                                       const quint8 channelID, const quint8 serviceID)
{
    QByteArray empty;
    empty.fill(0x00, 512);
...
void IdnPacketizer::generateIdlePacket(QByteArray& data, const quint32 seqnum,
                                       const quint8 channelID, const quint8 serviceID)
{
    data.clear();
    IDNDMX_PACKET packet;
...
void IdnPacketizer::generateClosePacket(QByteArray& data, const quint32 seqnum,
                                        const quint8 channelID, const quint8 serviceID)
{
    data.clear();
    IDNDMX_PACKET packet;
...
void IdnPacketizer::setPacketHeader(IDNDMX_PACKET *packet, unsigned char command,
