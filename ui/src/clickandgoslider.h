...
#define SLIDER_SS_COMMON                                                                           \
  "QSlider::groove:vertical { background: transparent; position: absolute; left: 4px; right: "     \
  "4px; } "                                                                                        \
  "QSlider::sub-page:vertical { background: QLinearGradient( x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 " \
  "#888, stop: 1 #ddd "                                                                            \
  ");"                                                                                             \
  "border: 1px solid #8E8A86; margin: 0 9px; }"                                                    \
  "QSlider::handle:vertical:disabled { "                                                           \
  "background: QLinearGradient(x1:0, y1:0, x2:0, y2:1, stop:0 #eee, stop:0.45 #999, stop:0.50 "    \
  "#555, stop:0.55 #999, "                                                                         \
  "stop:1 #aaa);"                                                                                  \
...
const QString CNG_DEFAULT_STYLE = SLIDER_SS_COMMON
    ...
    "background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #ddd, stop:0.45 #888, stop:0.50 "
    "#000, stop:0.55 #888, "
    "stop:1 #999);"
