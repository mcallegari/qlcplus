...
void VCXYPadArea_Test::mouseEvents()
{
    ...
    QMouseEvent e(QEvent::MouseButtonPress, QPoint(20, 30), QPoint(0, 0), QPoint(0, 0), Qt::LeftButton, Qt::NoButton,
                  Qt::NoModifier);
    ...
    QMouseEvent e2(QEvent::MouseButtonPress, QPoint(320, 330), QPoint(0, 0), QPoint(0, 0), Qt::LeftButton, Qt::NoButton,
                   Qt::NoModifier);
